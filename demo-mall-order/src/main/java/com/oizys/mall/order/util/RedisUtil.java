package com.oizys.mall.order.util;
...
public class RedisUtil {
    ...
    public long sSet(String key, Object... values) {
        try {
            ...
            log.error("添加set成员失败，key: {}, values: {}", key, values, e);
            return 0;
        }
    }
    ...
    public long sSetAndTime(String key, long time, Object... values) {
        try {
            ...
            log.error("添加set成员失败，key: {}, time: {}, values: {}", key, time, values, e);
            return 0;
        }
    }
    ...
    public long setRemove(String key, Object... values) {
        try {
            ...
            log.error("移除set成员失败，key: {}, values: {}", key, values, e);
            return 0;
        }
    }
    ...
    public Object lGetIndex(String key, long index) {
        try {
            ...
            log.error("通过索引获取list值失败，key: {}, index: {}", key, index, e);
            return null;
        }
    }
    ...
    public boolean lUpdateIndex(String key, long index, Object value) {
        try {
            ...
            log.error("根据索引修改list数据失败，key: {}, index: {}, value: {}", key, index, value, e);
            return false;
        }
    }
    ...
    public long lRemove(String key, long count, Object value) {
        try {
            ...
            log.error("移除list数据失败，key: {}, count: {}, value: {}", key, count, value, e);
            return 0;
        }
    }
    ...
    public Set<Object> zRange(String key, long start, long end) {
        try {
            ...
            log.error("获取有序集合元素失败，key: {}, start: {}, end: {}", key, start, end, e);
            return null;
        }
    }
    ...
    public Set<Object> zRangeByScore(String key, double min, double max) {
        try {
            ...
            log.error("获取有序集合元素失败，key: {}, min: {}, max: {}", key, min, max, e);
            return null;
        }
    }
    ...
    public long zRemove(String key, Object... values) {
        try {
            ...
            log.error("移除有序集合元素失败，key: {}, values: {}", key, values, e);
            return 0;
        }
    }
}